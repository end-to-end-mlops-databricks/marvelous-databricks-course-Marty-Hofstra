...
scope = "user"  # PLEASE CHANGE THIS NAME to your own name. a scope contains all your secrets
if scope not in [
    dict_entry["name"] for dict_entry in secret_api.list_scopes()["scopes"]
]:
...
your_secret = "blablabla"
secret_api.put_secret(scope=scope, key="test", string_value="blabla", bytes_value=None)
